...
INSERT INTO public.services VALUES (2, 'die');
...
--
-- Name: appointments appointments_servide_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointments_servide_id_fkey FOREIGN KEY (service_id) REFERENCES public.services(service_id);
